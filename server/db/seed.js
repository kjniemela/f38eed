...
async function seed() {
  ...
  santaigoConvo.addUser(thomas);
  santaigoConvo.addUser(santiago);
  ...
  chiumboConvo.addUser(chiumbo);
  chiumboConvo.addUser(thomas);
  ...
  hualingConvo.addUser(thomas);
  hualingConvo.addUser(hualing);
